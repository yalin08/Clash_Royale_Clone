...
namespace SRDebugger.Internal
{
    public static class SRDebuggerUtil
    {
        ...
        {
            if (!Settings.Instance.EnableEventSystemGeneration) return false;
            ...
            if (e != null && e.gameObject.activeSelf && e.enabled) return false;
        ...
        {
            if (value >= max) return exceedsMaxString;
